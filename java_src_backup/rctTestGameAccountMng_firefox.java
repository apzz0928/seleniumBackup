...
public class rctTestGameAccountMng_firefox {		
	    ...
	    public void gameBlock_characterLock() {
	        ...
	        elementWait("id", "ac_layout_footer");	        
	        elementWait("class", "uid_form_main_type_combo");
	        System.out.println("계정제재 관리 > 캐릭터 잠금 > 캐릭터 잠금 : Pass");
	  	}
	  	@Test(priority = 20)
	    ...
	    public void gameBlock_tradeLock() {
	        ...
	        elementWait("id", "ac_layout_footer");	        
	        elementWait("class", "uid_form_main_type_combo");
	        System.out.println("계정제재 관리 > 거래 잠금 > 거래 잠금 : Pass");
	  	}
	  	@Test(priority = 22)
	    ...
	    public void gameBlock_contentLock() {
	        ...
	        for(int i=80401; i<=80404 ; i++ ){
		        ...
		        System.out.println("계정제재 관리 > 컨텐츠 잠금 > " + content + " 잠금 : Pass");
	        }
	  	}
	  	@Test(priority = 24)
	    public void gameBlock_contentUnlock() {
	        ...
	        elementWait("id", "ac_layout_footer");	        
	        elementWait("class", "uid_form_main_type_combo");
	        System.out.println("계정제재 관리 > 컨텐츠 잠금 > 모든 컨텐츠 잠금 취소 : Pass");
	  	}
	  	@Test(priority = 25)
	    public void gameBlock_payLock() {
	        ...
	        elementWait("id", "ac_layout_footer");	        
	        elementWait("class", "uid_form_main_type_combo");
	        System.out.println("계정제재 관리 > 유료화 잠금 > 유료화 잠금 : Pass");
	  	}
	  	@Test(priority = 26)
	    public void gameBlock_payUnlock() {
	        ...
	        elementWait("id", "ac_layout_footer");	        
	        elementWait("class", "uid_form_main_type_combo");
	        System.out.println("계정제재 관리 > 유료화 잠금 > 유료화 잠금 취소 : Pass");
	  	}
	    @Test(priority = 27)
	    public void gameBlock_chatLock() {
	        ...
	        for(int i=80602; i<=80603 ; i++ ){
		        ...
		        System.out.println("계정제재 관리 > 채팅 제재 > " + content + " : Pass");
	        }
	  	}
	    @Test(priority = 28)
	    ...
	    public void gameBlock_mailLock() {
	        ...
	        for(int i=80701; i<=80702 ; i++ ){
		        ...
		        System.out.println("계정제재 관리 > 메일 제재 > " + content + " 금지 : Pass");
	        }
	  	}
	    //@Test(priority = 30)
	    public void gameBlock_mailUnlock() {
	        ...
	        elementWait("id", "ac_layout_footer");	        
	        elementWait("class", "uid_form_main_type_combo");
	        System.out.println("계정제재 관리 > 메일 제재 > 메일 제재 취소 : Pass");
	  	}
	  	@Test(priority = 99)
	    public void Logout(){
	        elementWait("id", "ac_layout_aside");
