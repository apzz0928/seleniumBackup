...
public class rctTest {
    ...
    @Test
    public void C_gameMng_B_systemMessage() throws Exception {
    ...
    @Test
    public void C_gameMng_C_ingameNotice() throws Exception {
    	//게임관리 > 인게임 공지로 이동
    ...
    @Test
    public void C_gameMng_D_kickUser() throws Exception {
    	//게임관리 > kickUser로 이동
    ...
    @Test
    public void C_gameMng_F_mailOut() throws Exception {
    ...
    @Test
    public void C_gameMng_G_burningEvent() throws Exception {
    ...
    @Test
    public void C_gameMng_H_getServerStatus() throws Exception {
    ...
    @Test
    public void C_gameMng_I_limitdrop() throws Exception {
    ...
    @Test
    public void C_gameMng_J_ingameGuide() throws Exception {
    ...
    @Test
    public void C_gameMng_K_onlineUserCountInfo() throws Exception {
    	//게임관리 > 온라인 유저수 조회로 이동
    ...
    @Test
    public void C_gameMng_L_slangForm() throws Exception {
   ...
   @Test
    public void C_gameMng_M_pvpSchedule() throws Exception {
    ...
    @Test
    public void D_authMng_A_authorityMenu() throws Exception {
    ...
    @Test
    public void D_authMng_B_authorityGroupMng() throws Exception {
    ...
    @Test 
    public void D_authMng_C_groupListByAdmin() throws Exception {
    ...
    @Test 
    public void D_authMng_D_ctActionLog() throws Exception {
    ...
    @Test 
    public void D_authMng_E_ctMember() throws Exception {
    ...
    @Test 
    public void E_gameAccountMng_A_accountSearch() throws Exception {
    ...
    @Test 
    public void E_gameAccountMng_B_recovery() throws Exception {
    ...
    @Test 
    public void E_gameAccountMng_B_uuidTracking() throws Exception {
